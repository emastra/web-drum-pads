...
//loadPresetSounds(); // new async way below
apiGET('/api/playlists/presets', loadPresetSounds);
//createSoundList('/sounds'); // new async way below
apiGET('/api/sounds', createSoundList);
//createPlaylistList('/playlists'); // i dont do it anymore
// load all effects
loadEffects();
